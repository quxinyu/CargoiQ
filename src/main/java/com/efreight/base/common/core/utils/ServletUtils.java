...
public class ServletUtils {
    ...
    public static Map<String, String> getHeaders(HttpServletRequest request) {
        ...
        if (enumeration != null) {
            while (enumeration.hasMoreElements()) {
                ...
                String value = urlDecode(request.getHeader(key));
                map.put(key, value);
            }
        }
        return map;
    ...
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, Object value) {
        return webFluxResponseWriter(response, HttpStatus.OK, value, ResultStatusCode.SYSTEM_ERR.getCode());
    }
    ...
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, String contentType, HttpStatus status, Object value, String code) {
        ...
        Result<?> result = new Result(code, value.toString());
